...
var rutas= function (app, swig) {
	...
	app.get('/user', function(req, res){
		...
		swig.renderFile(__dirname + '/../views/main.html', { imagenes: imagenes}, function (err, output) {
            if (err) {
                throw err;
            }
            res.send(output);
	...
	app.get('/subir-archivo', function(req, res){
		swig.renderFile(__dirname+ '/../views/cargar-img.html', {}, function(err, output){
			if (err) {
                throw err;
            }
            res.send(output);
	...
	app.post('/edit', function(req, res){
		swig.renderFile(__dirname+ '/../views/editar-img.html', {idImagen: req.body.idImagen}, function(err, output){
			if (err) {
                throw err;
            }
            res.send(output);
